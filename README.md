...
> **This project's code was generated by AI model MiMo-V2.5-Pro via OpenCode.**
> 
> All code modifications were made by AI automatically. There may be unknown bugs, please use with caution and verify yourself.
> 
> This modification is customized based on personal preferences and may not suit all users.
...
| Feature | Description |
|---------|-------------|
| **Table View** | Mods displayed in a table: Checkbox, Mod Name, Priority, Status |
...
- **AI Development**: MiMo-V2.5-Pro via OpenCode
  - All code modifications made by AI
